...
from sales_contract_engine import generate_contract_id, parse_date, safe_percent
...
def read_contract_at_row(row_number):
    ...
    try:
        ...
        return {
            ...
            "ignore_remaining_qty": safe_bool(safe_cell(sheet, row_number, "M")),
        }
    finally:
        workbook.close()
